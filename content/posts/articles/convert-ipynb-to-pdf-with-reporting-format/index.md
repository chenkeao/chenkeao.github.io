---
title: "Convert Jupyter Notebook to PDF With Reporting Format"
date: "2025-06-13"
toc: false
...
or dictate author names and the document title as converting:

```bash
jupyter nbconvert --to pdf --template-file assignment ./Journal.ipynb --LatexPreprocessor.author_names="Name" --LatexPreprocessor.title="Title"
```
